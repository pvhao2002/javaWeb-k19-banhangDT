							...
							<div class="homepage-brands-body">
								<div class="homepage-brands-group-top">
									<c:forEach var="brand" items="${brands}">
										<a href='<c:url value="/all-product-by-brand?brandId=${brand.brandId}"></c:url>' class="homepage-brands-item"> <img src='<c:url value="images/imageBrand/${brand.logo}"/>' alt="brand"></a> 
									</c:forEach>
								</div>
						...
						<div class="list_product-info-list">
							<c:forEach var="item" items="${listProduct}">
								<a
									...
									<img src='<c:url value="images/imageProduct/${item.imageId.imageSmall}"/>' alt="Hinh">
									<p class="list_product-info-item-name">${item.productName}</p>

									<p class="list_product-info-item-price">${item.price  } VNĐ</p>
								</a>
							</c:forEach>
							<!-- <a href="#" class="list_product-info-item"> <img
								src="https://cdn.tgdd.vn/Products/Images/42/239747/oppo-reno6-z-5g-aurora-1-600x600.jpg"
								alt="">
								<p class="list_product-info-item-name">OPPO Reno6 Pro 5G</p>

								<p class="list_product-info-item-price">9.490.000</p>
							</a> <a href="#" class="list_product-info-item"> <img
								src="https://cdn.tgdd.vn/Products/Images/42/239747/oppo-reno6-z-5g-aurora-1-600x600.jpg"
								alt="">
								<p class="list_product-info-item-name">OPPO Reno6 Pro 5G</p>
